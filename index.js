...
console.log(createMenuItem('pizza', 'tree fiddy', 'dankfood'));
console.log(createMenuItem('broccoli', '7500', 'water, BOIL, veg, IN'));
console.log(createMenuItem('omelet', 'a smooth milli', 'egg'))
